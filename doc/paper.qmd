...
* `fit_setting_contacts()`
    * Runs `fit_single_contact_model()` on each setting, to save running `fit_single_contact_model()` multiple times. Returns a list of fitted models. 

* `predict_contacts()`
    * This takes a fitted model from `fit_single_contact_model()` and predicts a contact matrix to provided age population structure.

* `predict_setting_contacts()`
    * Takes a list of fitted models from `fit_setting_contacts()` and predicts a contact matrix to provided age population structure.
